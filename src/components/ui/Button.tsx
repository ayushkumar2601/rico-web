...
export function Button({ children, onClick, className = "", variant = 'primary', icon }: ButtonProps) {
  ...
  const variants = {
    primary: "bg-neon-cyan text-black hover:bg-neon-teal shadow-[0_0_20px_rgba(0,240,255,0.3)] hover:shadow-[0_0_30px_rgba(0,240,255,0.5)]",
    secondary: "bg-white text-black hover:bg-slate-200 shadow-lg",
    outline: "bg-transparent border border-white/20 text-white hover:bg-white/5 hover:border-neon-cyan/50 hover:text-neon-cyan hover:shadow-[0_0_15px_rgba(0,240,255,0.1)]",
